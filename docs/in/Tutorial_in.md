...
[![Tutorial_in](https://github.com/yammadev/flag-icons/blob/master/png/IN.png?raw=true)](../in/Tutorial_in.md)
...
more detail, see [JSON as a Fact](JSON_Fact_in.md).
...
You can now build rules from JSON! [Read how it works](GRL_JSON_in.md) 
...
into GRB (Grules Rule Binary) file. [Read how to store and load GRB](Binary_Rule_File_in.md) 
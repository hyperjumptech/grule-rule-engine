...
| `"call"`  | GRL function call. The operator will call the function name specified in the first operand. If more then one operand is specififed, the subsequent operands are interpreted as arguments to be passed to the function call. |

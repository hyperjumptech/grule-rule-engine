...
This utility method `FetchMatchingRules` in `GruleEngine.go` fetches all the matching rules against a fact and returns list of `ast.RuleEntry` order by salience property.
